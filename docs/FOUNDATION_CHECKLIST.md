# Checklist de clôture de l’étape 1

- [x] Dépôt GitHub officiel identifié.
- [x] Branche stable et branche de développement séparées.
- [x] Cahier des charges complet enregistré.
- [x] Anciennes variantes dégradées exclues de la base officielle.
- [x] Pipeline reproductible à partir de sources texte.
- [x] Vrais atlas PNG générés au build.
