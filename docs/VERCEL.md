...
5. `vercel.json` vérifie les fichiers essentiels puis publie `public/`.
...
- le projet officiel `chroniques-de-solenne` n’est actuellement pas visible via le connecteur Vercel ;
